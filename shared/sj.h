...
// note (source: https://github.com/rxi/sj.h/tree/master)
#ifndef SJ_H
#define SJ_H
...
// note (Aaron): Modified this to have a type so that it's easier to tell with a debugger what the actual type is
typedef enum { SJ_ERROR, SJ_END, SJ_ARRAY, SJ_OBJECT, SJ_NUMBER, SJ_STRING, SJ_BOOL, SJ_NULL } Sj_Value_Type;
